...
const ChartLine = () => {
    ...
    const getWorkInProgess = () => {
        apiClient
            .get(
                "/api/v1/stats?from=" + startDate + "&days=" +
            ...
            <Container style={{ minHeight: "25rem" }}>
                <Row className="p-2 g-2">
                    <Col className="col-auto mx-auto order-md-1 my-2">
                        ...
                        >
                            <Dropdown.Item
                                onClick={() => setLabel(7, "This Week", moment().startOf("isoweek").format("YYYY-MM-DD"))}
                                active={numberOfSelectedDays == 7}
                                label="This Week"
                            >This Week</Dropdown.Item>
                            <Dropdown.Item
                                onClick={() => setLabel(31, "This Month", moment().startOf("month").format("YYYY-MM-DD"))}
                                active={numberOfSelectedDays == 31}
                                label="This Month"
                            >This Month</Dropdown.Item>
                            <Dropdown.Item
                                onClick={() => setLabel(365, "This Year", moment().startOf("year").format("YYYY-MM-DD"))}
